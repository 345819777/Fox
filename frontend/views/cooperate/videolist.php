...
<div class="main">
    ...
    <div class="main_right">
        	<p class="title" style="color:#ff1f1f">Video Tutorial</p>
            ...
            <?php }else{ ?>
                            <video id="example_video_1" class="video-js vjs-default-skin" controls preload="none" width="360" height="270" poster="/Public/Home/images/index_img/v.png" data-setup="{}">
