...
<div class="main">
        ...
        <ul class="ul1">
        	...
        	<li id="menu"><a href="/download-center/user-manual.html" style="color:red;">User Manual</a>
            	<ul id="Submenu">
                     ...
                     <!-- 
                      <li><a href="/Cooperate/manualCate/name/CloudService.html">&nbsp;&nbsp;Cloud Service</a></li>
                      <li><a href="/Cooperate/manualCate/name/Clientsoftware.html">&nbsp;&nbsp;Client software</a></li>
                     <li><a href="/Cooperate/manualCate/name/App.html">&nbsp;&nbsp;App</a></li>
                  -->
                  </ul>
            </li>
    ...
    <div class="main_right">
        	<p class="title" style="color:#ff1f1f">User Manual &gt;&gt;<?php echo $manualCate;?></p>
