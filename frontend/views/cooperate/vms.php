...
<div class="main">
	<div class="main_left">
        ...
        <ul class="ul1">
            ...
            <li><a href="/download-center/vms.html"  style="color:red;">VMS</a></li>
    ...
    <div class="main_right">
    	<ul>
        	<p class="title" style="color:#ff1f1f; font-size:20px; line-height:56px;">VMS Installation</p>
        </ul>
        <div style=" width:784px; margin:0 auto; margin-top:20px; margin-bottom:20px;">
			<p><a href="http://www.foscam.com/Private/vms/Foscam VMS （Windows）.zip">Click here</a> to download VMS installation package. </p>
        </div>
    </div>
