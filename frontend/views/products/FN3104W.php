...
.wrap-one {
	height: 768px;
	background: url(__ROOT__/Public/Home/images/goods_img/fn3104w/01.jpg) no-repeat center;
...
<div class="wrap-two">
    ...
    <img src="__ROOT__/Public/Home/images/goods_img/fn3104w/02.png" />
    </div>
</div>
<style type="text/css">
...
<div class="wrap-two-two">
	<div class="comWith">
        ...
        <div class="ft">
            ...
            <p><span style="font-size:50px;">500</span>&nbsp;<span style="font-size:30px;">ft</span></p>
            <p style="padding-top:10px;">(160 meters)</p>
        </div>
        
        <div class="tips">Tips: Please notice that the wireless signal distance is obtained in test environment.</div>
        
		<img src="__ROOT__/Public/Home/images/goods_img/fn3104w/05.png" />
    </div>
</div>


<div class="wrap-three" style="background: url(__ROOT__/Public/Home/images/goods_img/fn3104w/06.png) no-repeat center;">
	<div class="comWith">
...
<div class="wrap-four" style="background: url(__ROOT__/Public/Home/images/goods_img/fn3104w/07.png) no-repeat center;">
	<div class="comWith">
        <div class="h2" style="color:#FFF;">Multiple access for local and remote viewing</div>
		<div class="p" style="color:#FFF;">View and control your security system locally by connecting it to a monitor, or via major browsers such as IE, Firefox and Safari, or via iOS & Android App on mobile devices remotely. </div>
    </div>
</div>



<div class="wrap-seven" style="background: url(__ROOT__/Public/Home/images/goods_img/fn3104w/08.png) no-repeat center;">
	<div class="comWith">
...
<div class="wrap-eight" style="background: url(__ROOT__/Public/Home/images/goods_img/fn3104w/09.png) no-repeat center;">
	<div class="comWith">
...
<div class="wrap-ten">
    ...
    <img src="__ROOT__/Public/Home/images/goods_img/fn3104w/10.png" />
    </div>
</div>
<div class="wrap-eleven">
	<div class="comWith">
    <div class="h2">Main Features</div>
    <img src="__ROOT__/Public/Home/images/goods_img/fn3104w/11.png" />
    </div>
</div>
  <div class="main7" style="background:none;">
    <div class="main7_7"> <a class="goods_info_left">
    <img src="__ROOT__/Public/Home/images/goods_img/goods_info_left.png" width="65" /></a> 
    <a class="goods_info_right">
    <img src="__ROOT__/Public/Home/images/goods_img/goods_info_right.png" width="65" /></a>
      <div class="main7_7_div" style="margin-top:100px;">
        <ul>
          <li style=" display:block"><a href="#">
          <img src="__ROOT__/Public/Home/images/goods_img/fn3104w/FN3104W-1.jpg" /> </a></li>
        
       
          <li><a href="#"><img src="__ROOT__/Public/Home/images/goods_img/fn3104w/FN3104W-2.jpg" /></a></li>
          
         
          <li><a href="#"><img src="__ROOT__/Public/Home/images/goods_img/fn3104w/FN3104W-3.jpg" /></a></li>
          
        
          <li><a href="#"><img src="__ROOT__/Public/Home/images/goods_img/fn3104w/FN3104W-4.jpg" /></a></li>
...
<div id="techspecs" style="display:none;">
  ...
  <table id="tableizer-table">
    ...
    <tr>
      ...
      <td colspan="6">Microsoft IE8 and above versions, Firefox, Safari</td>
    </tr>
    <tr>
      <td>Smart phone</td>
  ...
  <div class="main7">
    <div class="main7_7">
      ...
      <div class="main7_7_div">
        <div class="left">
          <div style=" height:52px; width:294px; border:1px solid #85d7f3; background:url(images/goods_img/download.gif) 5px 5px no-repeat; "> <a href="__ROOT__/download-center/user-manual/{$id}.html">
          ...
          <div style=" margin-top:30px;height:52px; width
                        ...
                        :294px; border:1px solid #85d7f3; background:url(images/goods_img/download.gif) 5px 5px no-repeat; "> <a href="__ROOT__/download-center/quick-installation-guide/{$id}.html">
        ...
        <div class="right">
          <div style=" float:right; height:52px; width:294px; border:1px solid #85d7f3; background:url(images/goods_img/download.gif) 5px 5px no-repeat; "> <a href="__ROOT__/download-center/firmware-downloads/{$id}.html">
          ...
          <div style=" float:right;  margin-top:30px;height:52px; width:294px; border:1px solid #85d7f3; background:url(images/goods_img/download.gif) 5px 5px no-repeat; "> <a href="__ROOT__/download-center/software-tools/{$id}.html">
...
function switchDayNight()
{
	$('.dn .day').click(function(){
		$('.dn').prev().attr('src','__ROOT__/Public/Home/images/goods_img/FN7108E_03.png');
		...
		$('.dn .day img').attr('src','__ROOT__/Public/Home/images/goods_img/day_1.png');
		$('.dn .night img').attr('src','__ROOT__/Public/Home/images/goods_img/night_1.png');
	});
	$('.dn .night').click(function(){
		$('.dn').prev().attr('src','__ROOT__/Public/Home/images/goods_img/FN7108E_03-2.jpg');
		$('.wrap-three').css('background','#000');
		$('.wrap-three *').css('color','#fff');
		$('.dn .night').css('background-color','#000');
		$('.dn .day').css('background-color','#000');
		$('.dn .day img').attr('src','__ROOT__/Public/Home/images/goods_img/day_2.png');
		$('.dn .night img').attr('src','__ROOT__/Public/Home/images/goods_img/night_2.png');
	});
}
function wrapTwo(){
	$(document).scroll(function(){
