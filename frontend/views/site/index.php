...
<!--header完-->
	...
	<div style="  margin-top: 300px;position: absolute;z-index: 1;right: 520px;top: 400px;" id="turn">
		...
		<ul style="position:relative; top:-732px;" id="banner_turn">  
            <?php foreach($banner_list as $k=>$v){ ?>
            <a href="<?php echo Url::to(['site/banner','id'=>$v->id]);?>" style="cursor:pointer;">
			<li class="banner_1" style="background:url(<?php echo $v->img;?>) no-repeat center;background-size:cover; position:relative;">
			<?php echo $v->content;?>
			</li></a>
			<?php } ?>
		</ul>
