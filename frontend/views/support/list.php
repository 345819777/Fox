	...
	<div style="text-align:center; color:#FFF;padding-top:20px; padding-bottom:10px; font-size: 0.5rem;">Welcome to Foscam Support</div>
		<div class="search_box">
			<form action="<?php echo Url::to(['support/search']);?>" method="get">
            	<input type="hidden" name="hideTit" id="hideTit" value="<?php echo $hideTit;?>" />
...
<div style="background:#FFF; margin-top:0.3rem;">
    <div class="list-box" style="clear:both; overflow: hidden;">
        ...
        <ul class="model-list">
            ...
            <li><a href='/Support/faqview/id/<?php echo $val->id; ?>.html?hideTit=<?php echo $hideTit; ?>'><div class="info"><?php echo $val->title;?></div><p class="watch"><i class="g-ico"></i></p></a></li>
            <?php } ?>		
        </ul>
		<?php if($more == 1){ ?>
            ...
            success: function (json) {
					...
					for (var i=0; i<json.lists.length; i++) {
                         /*infoList  +=   '<a class="item opacity" href="'+json.lists[i].id+'">'
                                        ...
                                        +'</a>';*/
					infoList += '<li><a href="/Support/faqview/id/'+json.lists[i].id+'.html?hideTit='+hideTit+'"><div class="info">'
						 			+''+json.lists[i].title+''
