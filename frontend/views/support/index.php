...
<div class="_container">
        ...
        <a href='<?php echo Url::to(['support/list','hideTit'=>$hideTit,'id'=>$val->id]);?>'>
...
<div style="background:#FFF; margin-top:0.3rem;">
    <div class="list-box" style="clear:both; overflow: hidden;">
        ...
        <ul class="model-list">
            ...
            <li><div class="info"><a href='/Support/faqview/id/<?php echo $val->id; ?>.html?hideTit=<?php echo $hideTit; ?>'><?php echo $val->title;?></a></div><p class="watch"><i class="g-ico"></i></p></li>
            <?php } ?>
